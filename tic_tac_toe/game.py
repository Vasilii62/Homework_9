...
def pc_choice(dic):  # Игра против ПК
    ...
    # Проверка клетки 3
    if ((dic['1'] == '0' and dic['2'] == '0') or
        (dic['7'] == '0' and dic['5'] == '0') or
        (dic['6'] == '0' and dic['9'] == '0')) \
            and dic['3'] == '.':
        return '3'
    # Проверка клетки 6
    elif ((dic['4'] == '0' and dic['5'] == '0') or
          (dic['3'] == '0' and dic['9'] == '0')) \
            and dic['6'] == '.':
        return '6'
    # Проверка клетки 9
    elif ((dic['7'] == '0' and dic['8'] == '0') or
          (dic['1'] == '0' and dic['5'] == '0') or
          (dic['3'] == '0' and dic['6'] == '0')) \
            and dic['9'] == '.':
        return '9'
    # Проверка клетки 2
    elif ((dic['5'] == '0' and dic['8'] == '0') or
          (dic['1'] == '0' and dic['3'] == '0')) \
            and dic['2'] == '.':
        return '2'
    # Проверка клетки 5
    elif ((dic['2'] == '0' and dic['8'] == '0') or
          (dic['4'] == '0' and dic['6'] == '0') or
          (dic['3'] == '0' and dic['7'] == '0') or
          (dic['1'] == '0' and dic['9'] == '0')) \
            and dic['5'] == '.':
        return '5'
    # Проверка клетки 8
    elif ((dic['7'] == '0' and dic['9'] == '0') or
          (dic['2'] == '0' and dic['5'] == '0')) \
            and dic['8'] == '.':
        return '8'
    # Проверка клетки 1
    elif ((dic['2'] == '0' and dic['3'] == '0') or
          (dic['5'] == '0' and dic['9'] == '0') or
          (dic['4'] == '0' and dic['7'] == '0')) \
            and dic['1'] == '.':
        return '1'
    # Проверка клетки 4
    elif ((dic['1'] == '0' and dic['7'] == '0') or
          (dic['5'] == '0' and dic['6'] == '0')) \
            and dic['4'] == '.':
        return '4'
    # Проверка клетки 7
    elif ((dic['1'] == '0' and dic['4'] == '0') or
          (dic['5'] == '0' and dic['3'] == '0') or
          (dic['8'] == '0' and dic['9'] == '0')) \
            and dic['7'] == '.':
        return '7'
    # Для проверки 2-х "Х" в ряд
    # Проверка клетки 3
    elif ((dic['1'] == 'x' and dic['2'] == 'x') or
          (dic['7'] == 'x' and dic['5'] == 'x') or
          (dic['6'] == 'x' and dic['9'] == 'x')) \
            and dic['3'] == '.':
        return '3'
    # Проверка клетки 6
    elif ((dic['4'] == 'x' and dic['5'] == 'x') or
          (dic['3'] == 'x' and dic['9'] == 'x')) \
            and dic['6'] == '.':
        return '6'
    # Проверка клетки 9
    elif ((dic['7'] == 'x' and dic['8'] == 'x') or
          (dic['1'] == 'x' and dic['5'] == 'x') or
          (dic['3'] == 'x' and dic['6'] == 'x')) \
            and dic['9'] == '.':
        return '9'
    # Проверка клетки 2
    elif ((dic['5'] == 'x' and dic['8'] == 'x') or
          (dic['1'] == 'x' and dic['3'] == 'x')) \
            and dic['2'] == '.':
        return '2'
    # Проверка клетки 5
    elif ((dic['2'] == 'x' and dic['8'] == 'x') or
          (dic['4'] == 'x' and dic['6'] == 'x') or
          (dic['3'] == 'x' and dic['7'] == 'x') or
          (dic['1'] == 'x' and dic['9'] == 'x')) \
            and dic['5'] == '.':
        return '5'
    # Проверка клетки 8
    elif ((dic['7'] == 'x' and dic['9'] == 'x') or
          (dic['2'] == 'x' and dic['5'] == 'x')) \
            and dic['8'] == '.':
        return '8'
    # Проверка клетки 1
    elif ((dic['2'] == 'x' and dic['3'] == 'x') or
          (dic['5'] == 'x' and dic['9'] == 'x') or
          (dic['4'] == 'x' and dic['7'] == 'x')) \
            and dic['1'] == '.':
        return '1'
    # Проверка клетки 4
    elif ((dic['1'] == 'x' and dic['7'] == 'x') or
          (dic['5'] == 'x' and dic['6'] == 'x')) \
            and dic['4'] == '.':
        return '4'
    # Проверка клетки 7
    elif ((dic['1'] == 'x' and dic['4'] == 'x') or
          (dic['5'] == 'x' and dic['3'] == 'x') or
          (dic['8'] == 'x' and dic['9'] == 'x')) \
            and dic['7'] == '.':
        return '7'
